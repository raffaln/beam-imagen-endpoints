...
def load_model():
    """
    Descarga y carga los pesos de Real_HAT_GAN_SRx4_sharper usando spandrel en on_start.
    """
    ...
    # Inicializar spandrel_extra_arches para soportar arquitectura HAT
    import spandrel
...
@endpoint(
    ...
    image=BeamImage(
        ...
        python_packages=["torch", "torchvision", "spandrel", "spandrel_extra_arches", "pillow", "numpy"],
    ),
)
def upscale(context, **kwargs):
    """
    Handler principal para procesar solicitudes de reescalado premium con Real-HAT-GAN.
    """
    ...
    if not image_base64:
        return {
            ...
            "beam_endpoint_name": "beam-hat-real-hat-gan-srx4-sharper",
